...
class Holding {
    constructor(init) {
        this.amount = "0";
        this.position = WalletPositions.BOTH;
        this.avgPrice = "0";
        this.lever = 1;
        this.deposit = "0";
        this.upl = "0";
...
exports.Tx = Tx;
class ListTransferArg {
}
exports.ListTransferArg = ListTransferArg;
var TransferSides;
(function (TransferSides) {
    TransferSides["Withdraw"] = "withdraw";
    TransferSides["Deposit"] = "deposit";
})(TransferSides = exports.TransferSides || (exports.TransferSides = {}));
var TransferStatuses;
(function (TransferStatuses) {
    TransferStatuses["Pending"] = "pending";
    TransferStatuses["Cancelled"] = "cancelled";
    TransferStatuses["Done"] = "done";
