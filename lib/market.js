    ...
    startCacheTicker(args) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                ...
                this.client.startCacheTicker(arg, (err) => {
                    if (err) {
                        reject(err);
                        return;
                    }
    ...
    stopCacheTicker(args) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                ...
                this.client.stopCacheTicker(arg, (err) => {
                    if (err) {
                        reject(err);
                        return;
                    }
    ...
    startCacheKLine(args) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                ...
                this.client.startCacheKLine(arg, (err) => {
                    if (err) {
                        reject(err);
                        return;
                    }
    ...
    stopCacheKLine(args) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                ...
                this.client.stopCacheKLine(arg, (err) => {
                    if (err) {
                        reject(err);
                        return;
                    }
    ...
    startCacheDepth(args) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                ...
                this.client.startCacheDepth(arg, (err) => {
                    if (err) {
                        reject(err);
                        return;
                    }
    ...
    stopCacheDepth(args) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                ...
                this.client.stopCacheDepth(arg, (err) => {
                    if (err) {
                        reject(err);
                        return;
                    }
