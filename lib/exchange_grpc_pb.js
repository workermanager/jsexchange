...
function serialize_exchange_Bool(arg) {
  if (!(arg instanceof exchange_pb.Bool)) {
    throw new Error('Expected argument of type exchange.Bool');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_exchange_Bool(buffer_arg) {
  return exchange_pb.Bool.deserializeBinary(new Uint8Array(buffer_arg));
}
...
listLatestTicker: {
  ...
  startCacheTicker: {
    ...
    responseStream: false,
    requestType: exchange_pb.TickerArg,
    responseType: exchange_pb.Bool,
    requestSerialize: serialize_exchange_TickerArg,
    requestDeserialize: deserialize_exchange_TickerArg,
    responseSerialize: serialize_exchange_Bool,
    responseDeserialize: deserialize_exchange_Bool,
  },
  stopCacheTicker: {
