...
function serialize_exchange_SymbolList(arg) {
  if (!(arg instanceof exchange_pb.SymbolList)) {
    throw new Error('Expected argument of type exchange.SymbolList');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_exchange_SymbolList(buffer_arg) {
  return exchange_pb.SymbolList.deserializeBinary(new Uint8Array(buffer_arg));
}
...
listSymbol: {
    ...
    responseType: exchange_pb.SymbolList,
    requestSerialize: serialize_exchange_SymbolArg,
    requestDeserialize: deserialize_exchange_SymbolArg,
    responseSerialize: serialize_exchange_SymbolList,
    responseDeserialize: deserialize_exchange_SymbolList,
  },
  // ticker
listLatestTicker: {
