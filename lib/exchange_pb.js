...
goog.exportSymbol('proto.exchange.SymbolList', null, global);
 ...
 * @constructor
 */
proto.exchange.SymbolList = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.exchange.SymbolList.repeatedFields_, null);
};
goog.inherits(proto.exchange.SymbolList, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.exchange.SymbolList.displayName = 'proto.exchange.SymbolList';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.exchange.SymbolList.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.exchange.SymbolList.prototype.toObject = function(opt_includeInstance) {
  return proto.exchange.SymbolList.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.exchange.SymbolList} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.exchange.SymbolList.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.exchange.SymbolList}
 */
proto.exchange.SymbolList.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.exchange.SymbolList;
  return proto.exchange.SymbolList.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.exchange.SymbolList} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.exchange.SymbolList}
 */
proto.exchange.SymbolList.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.exchange.SymbolList.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.exchange.SymbolList.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.exchange.SymbolList} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.exchange.SymbolList.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!Array<string>}
 */
proto.exchange.SymbolList.prototype.getSymbolsList = function() {
 ...
 * @return {!proto.exchange.SymbolList} returns this
 */
proto.exchange.SymbolList.prototype.setSymbolsList = function(value) {
 ...
 * @return {!proto.exchange.SymbolList} returns this
 */
proto.exchange.SymbolList.prototype.addSymbols = function(value, opt_index) {
 ...
 * @return {!proto.exchange.SymbolList} returns this
 */
proto.exchange.SymbolList.prototype.clearSymbolsList = function() {
